...
<body>
    <header>
        ...
        <nav>
            <ul>
                <li><a class="a_nav" href="#">Introduzione</a></li>
                <li><a class="a_nav" href="#">Norme sulla privacy</a></li>
                <li><a class="a_nav" href="#">Termini di Servizio</a></li>
                <li><a class="a_nav" href="#">Tecnologie</a></li>
                <li><a class="a_nav" href="#">Domande frequenti</a></li>
            </ul>
        </nav>
    </header>
    <main>
